...
const config = {
  title: 'Liferay - Poshi Documentation',
  tagline: 'Poshi Actions and Macro Documentation',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: 'https://liferay.com', label: 'Liferay', position: 'left'},
          {
